...
public class NewTest {
	private static String url = "http://localhost:8183/2AutomateWebApp/index.jsp";
	...
	public void ValidateLoginScript() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\sandh\\Downloads\\chromedriver_win32 (1)/chromedriver.exe ");
	...
	private void addDetailsToLoginForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"fname\"]")).sendKeys("Sandhya");
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("");
		driver.findElement(By.xpath("//*[@id=\"pass\"]")).sendKeys("sandhya");
	...
	private void addDetailToRegisterForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("sandhya@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"psw\"]")).sendKeys("sandhya");
		driver.findElement(By.xpath("//*[@id=\"psw-repeat\"]")).sendKeys("sandhya");
