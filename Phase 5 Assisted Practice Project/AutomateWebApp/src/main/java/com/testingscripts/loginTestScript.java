...
public class loginTestScript {
	private static String url = "http://localhost:8183/AutomateWebApp/index.jsp";
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Sandhya", "sandhya@gmail.com", "Sandhya");// get login data
		addDetailToRegisterForm(driver, "Sandhya@gmail.com", "Sandhya", "Sandhya");// get register data
